        ...
        try {
            ...
            if (netOn && paid) {
                ...
                try {
                    ...
                    // Save Supabase record in Realm
                    realm.write(() => {
                        addedContact = realm.create('Contact', {
                            ...contactData,
                            id: supaContact.id,
                            syncStatus: 'synced',
                            needsUpload: false,
                    ...
                    realm.write(() => {
                        addedContact = realm.create('Contact', contactData);
                        realm.create('SyncLog', {
                            id: Date.now().toString() + '_' + contactData.id,
                            userId: userId,
                            tableName: 'contacts',
